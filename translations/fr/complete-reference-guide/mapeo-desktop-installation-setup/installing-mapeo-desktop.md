...
Mapeo Desktop will open automatically when the installation process finishes. If not, go to your computer's desktop or **Apps** and click the ![](../../.gitbook/assets/Md-icon.png)**Mapeo Desktop** icon to open the application.
...
4. Once the install is complete, find ![](../../.gitbook/assets/Md-icon.png) **Mapeo** in your **Applications** folder and double click it to open.
