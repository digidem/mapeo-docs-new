...
3. Tap **MANUAL COORDS** to manually enter the coordinates that you want to use.\ \ ![](../../../.gitbook/assets/Weak GPS signal message - manual coords option.jpg)  \ \ You can choose which GPS data format you want to use to enter the coordinates. This is a useful option if you have a GPS device or another smartphone with a better GPS signal accuracy. \ \ ![](../../../.gitbook/assets/Enter coordinates screen - menu to chose format.jpg)  ![](../../../.gitbook/assets/Enter coordinates screen - choose GPS format with cover.jpg)\ \ Tap ![](../../../.gitbook/assets/app icons\_Save-check.png) **Save** once you have manually entered the coordinates to return to the **Edit observation** screen.
