...
To update Mapeo Desktop, follow the same steps of the installation process using a newer installation file. Before starting, ensure that the ![](<../../../.gitbook/assets/image (3) (1).png>) **Mapeo Desktop** application is not open. Then, follow the steps below for:
