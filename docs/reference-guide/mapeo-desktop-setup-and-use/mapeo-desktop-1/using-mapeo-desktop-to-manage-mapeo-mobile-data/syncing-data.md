...
* ****[**Synchronization via Wi-Fi**](syncing-data.md#synchronization-via-wifi)  ****  (![](<../../../../.gitbook/assets/image (9) (1).png>)![](<../../../../.gitbook/assets/smartphone with Mapeo>))\
...
* ****[**Synchronization with a file**](syncing-data.md#synchronization-with-a-file) **** (![](<../../../../.gitbook/assets/image (9) (1).png>)![](<../../../../.gitbook/assets/image (9) (1).png>))\
...
* ****[**Send sync file via email or file sharing service**](syncing-data.md#send-sync-file-via-email-or-file-sharing-service)\
  (Requires an ![](<../../../../.gitbook/assets/internet in a computer>)internet connection)
* ****[**Copy and paste sync file using a USB drive**](syncing-data.md#option-2.-copy-pasting-it-among-different-devices-with-no-internet-connection-you-will-need-a-usb-dr)\
  (Works with ![](<../../../../.gitbook/assets/NO internet in a computer>)no internet connection)
...
Computer 2 then syncs with the file. ](<../../../../.gitbook/assets/sync file via internet.jpg>)
...
Computer 2 then syncs with the file.](<../../../../.gitbook/assets/sync file via usb (1).jpg>)
